...
public class EntityGrossArrow extends EntityTrickArrow
{
    ...
    public EntityGrossArrow(World world, LivingEntity shooter, float velocity)
    {
        super(world, shooter, velocity);
    }

    public EntityGrossArrow(World world, LivingEntity shooter, float velocity, boolean horizontal)
    {
