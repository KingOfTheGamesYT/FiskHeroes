        ...
        if (phase == Phase.END && enabled)
        {
            ...
            if (SHData.SHOOTING.get(entity))
            {
                ...
                if (rayTrace != null)
                {
                    ...
                    {
                        SHHelper.melt(entity.world, rayTrace.blockX, rayTrace.blockY, rayTrace.blockZ, Rule.GRIEF_HEATVISION.get(entity.world, rayTrace.blockX, rayTrace.blockZ) ? 15 : 3);
                    }
                }
